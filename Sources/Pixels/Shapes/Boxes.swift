extension Pixels {
    public mutating func drawBox(x: Int, y: Int, width: Int, height: Int, radius: Int = 0, color: ColorDepth = ColorDepth.max, dotted isDottedEnabled: Bool = false, brushSize: Int = 1, filled isFilled: Bool = false) {
        var radius = radius
